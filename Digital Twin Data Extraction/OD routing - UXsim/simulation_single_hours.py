...
total_hours = 24
total_seeds = 5
list_hours = [i for i in range(total_hours)]
...
namefile_output_edges="results/UXsim_links/AreaVerde_links_single_hours"
namefile_output_zones="results/UXsim_vehicles/AreaVerde_vehicles_ALL_single_hours"
